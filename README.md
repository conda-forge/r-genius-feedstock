...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-genius-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `r-genius` can be installed with:

```
conda install r-genius
```

It is possible to list all of the versions of `r-genius` available on your platform with:
